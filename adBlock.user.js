...
let ogVolume=1,pbRate = 1;setInterval(()=>{
    if(document.getElementsByClassName("video-stream html5-main-video")[0]!==undefined){
        ...
        if(document.querySelector(".ytp-skip-ad-button")!==null){document.querySelector(".ytp-skip-ad-button").click()}
        ...
        if(document.getElementsByClassName("ytd-popup-container")[0]!==undefined){let popupBoxes = document.getElementsByClassName("ytd-popup-container");for(let i=0;i<popupBoxes.length;i++){popupBoxes[0].remove()}};
